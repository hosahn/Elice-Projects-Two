  ...
  return (
    <>
      ...
      <Container maxWidth="lg" style={{ marginTop: "20px" }} component="div" xs="1">
        ...
        <Grid><h2>{data?.result?.[0]["title"]}과 비슷한 술</h2></Grid>
        ...
        <Grid> <h2>{data?.result?.[0]["title"]}과 잘 어울리는 안주</h2></Grid>
        <Grid container xs={12} spacing={1} >
          
          <Grid item xs={4} sx={{ border: "1px solid lightgray", p: 2 }} style={{ display: "flex", alignItems: "center" }}>
